...
from hub.views import ProjectLissstView, homePage, list_Student, detail_student, listprojet, addStudent, addstudentform, addstudentmodelformm, StudentCreateView, StudentUpdateView,StudentDeleteView,deletestudent
...
urlpatterns = [
    ...
    path('UpdateStudentView/<int:pk>', StudentUpdateView.as_view(), name='UpdateStudentView'),
