...
from hub.views import ProjectLissstView, homePage, list_Student,detail_student,listprojet,addStudent,addstudentform,addstudentmodelformm,StudentCreateView
...
urlpatterns = [
    ...
    path('studentaddjedida3/',StudentCreateView.as_view(), name= 'studentaddjedida3')
